...
//
 ...
 CSF::createSection ($prefix, array(
'parent' =>'accordion_1',
'title' =>'Protfolio Header',
'icon' =>'fas fa-star',
 'fields' =>array(
    array(
  'id'        => 'protfolio_header_group_1',
  'type'      => 'group',
  'title'     => 'Header link',
    'button_title' =>'Add Social Link',
  'fields'    => array(
    array(
      'id'    => 'link_1',
      'type'  => 'text',
...
'icon' =>'fas fa-rocket',
 ...
 'id'      => 'section_sub',
  ...
  'placeholder' => 'section sub title here',
...
//
// Create Custom Switcher preloader section
//
...
'fields' => array(
    array(
    'id' =>'second_section_group',
      'type'      => 'group',
        'title'=>'Group',
        'button_title' =>'Add Intro Sub Section',
        'fields' =>array(
            array(
...
CSF::createSection($prefix, array(
        ...
        'fields'   =>array(
            ...
            array(
                    ...
                    'type'=> 'text',
                    'title'=>'Section Name',
                    'desc' =>'section name here for example: page name',
                ),
                ...
                array(
                    ...
                    'type'=> 'text',
                    'title'=>'Title',
                    'desc' =>'section Title here',
                ),
            
                
            array(
            'id'      =>'third_section_group',
            'type'    =>'group',
            ...
            'fields'  =>array(
                ...
                array(
                  ...
                  'type'  => 'text',
                  'title' => 'Link Button',
                    'desc' =>'create a link that connection with button',
                ),
...
CSF::createSection($prefix,array(
		...
		'fields' =>array(
			...
			'type' =>'group',
			'title' =>'add service',
			'button_title' =>'Your company service',	
			'fields' =>array(
...
//
// Create Our Testomonials  section start
//
